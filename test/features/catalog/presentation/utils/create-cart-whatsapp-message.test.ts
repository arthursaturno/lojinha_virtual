...
describe("createCartWhatsAppMessage", () => {
  it("includes cart values and applied benefit details", () => {
    const message = createCartWhatsAppMessage({
      ...
      promotion: {
        isValid: true,
        message: "Beneficio aplicado.",
        benefitTitle: "10% no carrinho",
        originalTotal: 200,
        productDiscount: 20,
        benefitDiscount: 10,
        shippingAmount: 0,
    ...
    expect(message).toContain("Beneficio selecionado: 10% no carrinho");
